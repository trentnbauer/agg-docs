...
* [Mini Guides](guides/mini-guides/README.md)
  * [Valheim FPS Boost](guides/mini-guides/valheim-fps-boost.md)
  * [Redirect domain to Google Site](guides/mini-guides/cloudflare-domain-to-google-sites.md)
  * [Docker Compose](guides/mini-guides/docker-compose/README.md)
    * ['All' Compose File](guides/mini-guides/docker-compose/all-compose-file.md)
    * [Add Health Check to Container](guides/mini-guides/docker-compose/add-health-check-to-container.md)
    * [Mount NFS Share to Container](guides/mini-guides/docker-compose/mount-nfs-share-to-container.md)
    * [Map hostname to container](guides/mini-guides/docker-compose/map-hostname-to-container.md)
...
* [Pterodactyl](guides/pterodactyl/README.md)
  ...
  * [Configuring your Node Database](guides/pterodactyl/configuring-your-database.md)
